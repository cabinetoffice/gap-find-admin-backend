...
(
    api_key_id integer NOT NULL GENERATED BY DEFAULT AS IDENTITY ( INCREMENT 1 START 1 MINVALUE 1 MAXVALUE 2147483647 CACHE 1 ),
    funder_id integer NOT NULL,
    api_key_value VARCHAR(40) NOT NULL,
    api_key_name VARCHAR(50) NOT NULL,
    api_key_description TEXT,
    CONSTRAINT api_key_pkey PRIMARY KEY (api_key_id),
    CONSTRAINT grant_funding_organisation_fk FOREIGN KEY (funder_id)
