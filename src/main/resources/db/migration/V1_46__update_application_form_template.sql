-- Updating hintText for BENEFITIARY_LOCATION question to use "\n" instead of "\\n"
    ...
    },
    {
      ...
      "questions": [
        ...
        },
        {
          ...
          "fieldTitle": "Enter your Charity Commission number (if you have one)",
        ...
        },
        {
          ...
          "fieldTitle": "Enter your Companies House number (if you have one)",
          "hintText": "Funding organisation might use this to identify your organisation when you apply for a grant. It might also be used to check your organisation is legitimate.",
