...
public class ValidationMaps {
    ...
    public final static ConcurrentHashMap<String, Object> SHORT_ANSWER_VALIDATION = new ConcurrentHashMap<>(
    ...
    public final static ConcurrentHashMap<String, Object> LONG_ANSWER_VALIDATION = new ConcurrentHashMap<>(
    ...
    public final static ConcurrentHashMap<String, Object> NUMERIC_ANSWER_VALIDATION = new ConcurrentHashMap<>(
            Map.ofEntries((new AbstractMap.SimpleEntry<String, Object>("greaterThanZero", true))));

    public final static ConcurrentHashMap<String, Object> SINGLE_FILE_UPLOAD_VALIDATION = new ConcurrentHashMap<>(
