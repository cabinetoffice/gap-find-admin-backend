...
//        ArgumentCaptor<FeedbackEntity> argument = ArgumentCaptor.forClass(FeedbackEntity.class);
//        FeedbackEntity feedbackEntity = FeedbackEntity.builder().satisfaction(1).build();
//        Mockito.when(FeedbackServiceTest.this.feedbackRepository.save(argument)).thenReturn(Optional.of((feedbackEntity)));
