...
public class FeedbackServiceTest {
    ...
    public void addFeedbackWithSatisfactionScoreOnly() {
        ...
        feedbackService.addFeedback(1, null, "advert");
    }

    @Test
    public void addFeedbackWithSatisfactionScoreOutwithLimit() {
        feedbackService.addFeedback(9, null, "advert");
    }

    @Test
    public void addFeedbackWithCommentOnly() {
        feedbackService.addFeedback(0, "I'm satisfied!", "advert");
    }

    @Test
    public void addFeedbackWithNoScoreAndEmptyComment() {
        feedbackService.addFeedback(0, "", "advert");
    }

    @Test
    public void addFeedbackWithSatisfactionScoreAndComment() {
        feedbackService.addFeedback(0, "I'm so satisfied!", "advert");
    }

    @Test
    public void addFeedbackWithNoContent() {
        feedbackService.addFeedback(0, null, "advert");
    }
